...
class Paypal_Service {
    ...
    public function __construct($sandbox = false) {
        $config = Zend_Registry::get('paypal');
        
        $this->SandboxFlag   = ($config['test'] == 1) ? true : false;
        $this->API_UserName  = $config['user'];
        $this->API_Password  = $config['pass'];
    ...
    */
    ...
    '-------------------------------------------------------------------------------------------
    */
    protected function GetShippingDetails( $token )
    {
        //'--------------------------------------------------------------
